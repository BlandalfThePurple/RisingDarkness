...
namespace RisingDarkness.Items
{
    ...
    public class TrueGlove : ModItem
    {
        ...
        {
            item.name = "True Power Glove";
            item.width = 10;
            item.height = 10;
            item.rare = -11;
            item.maxStack = 1;
            item.toolTip = "YOU got the powah.";
            item.value = Item.buyPrice(7, 0, 0, 0);
            item.useAnimation = 2;
            item.useTime = 20;
            item.useStyle = 1;
            item.accessory = true;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "PortaHole", 1);
            recipe.AddIngredient(null, "HallowedGlove", 1);
